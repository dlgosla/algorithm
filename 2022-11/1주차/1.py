...
airbnb_db = db.get_collection("temp")
...
# print(airbnb_db)
# airbnb_db.drop_database()

# airbnb_db.delete_many({"listing_url": None})

airbnb_db.create_index(
    [
        ("name", "text"),
        ("bed_type", "text"),
        ("_id", 1),
...
# airbnb_db.insert_many(
#     [
#         {
#             "listing_url": "https://www.airbnb.com/rooms/10006546",
#             "name": "RibeiraCharmingDuplex sss",
